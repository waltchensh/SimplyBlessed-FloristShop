      ...
      <ul >
        <li id="blue">
					<div class="product-image">
						<img src="flowers/blue01.jpg" alt="" />
					</div>
					<div class="product-description" data-name="滿天·星火" data-price="450">
						<h3 class="product-name">滿天·星火</h3>
						<p class="product-price">NTD$450</p>
