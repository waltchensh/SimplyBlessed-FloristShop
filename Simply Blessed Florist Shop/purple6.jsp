      ...
      <ul >
        <li>
					<div class="product-image">
						<img src="flowers/purple06.jpg" alt="" />
					</div>
					<div class="product-description" data-name="天上·人間" data-price="400">
						<h3 class="product-name">天上·人間</h3>
						<p class="product-price">NTD$400</p>
						<form class="add-to-cart" action="cart.jsp" method="post">
							<div>
								<label for="qty-6">數量</label>
								<input type="text" name="qty-6" id="qty-6" class="qty" value="1" >
							</div>

							<p><input type="submit" value="加入購物車" class="btn" rel="external nofollow" ></p>
						</form>
					</div>
				</li>
      </ul>
