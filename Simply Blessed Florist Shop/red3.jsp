      ...
      <ul >
        <li>
					<div class="product-image">
						<img src="flowers/red03.jpg" alt="" />
					</div>
					<div class="product-description" data-name="絢爛·煙火" data-price="500">
						<h3 class="product-name">絢爛·煙火</h3>
						<p class="product-price">NTD$500</p>
						<form class="add-to-cart" action="cart.jsp" method="post">
							<div>
								<label for="qty-3">數量</label>
